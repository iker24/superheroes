...
use uni\Bundle\superheroesBundle\Entity\TIPOS;
use uni\Bundle\superheroesBundle\Form\TIPOSType;
...
class TIPOSController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('unisuperheroesBundle:TIPOS')->findAll();

        return $this->render('unisuperheroesBundle:TIPOS:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('unisuperheroesBundle:TIPOS:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('unisuperheroesBundle:TIPOS')->find($id);
        ...
        return $this->render('unisuperheroesBundle:TIPOS:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('unisuperheroesBundle:TIPOS:edit.html.twig', array(
            'entity'      => $entity,
